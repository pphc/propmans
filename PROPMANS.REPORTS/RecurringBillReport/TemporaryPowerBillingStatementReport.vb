...
Public Class TemporaryPowerBillingStatementReport
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "TemporaryPowerBillingStatementReport.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "PROPMANS.REPORTS.TemporaryPowerBillingStatementReport.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property AssociationDuesSection() As CrystalDecisions.CrystalReports.Engine.Section
        Get
...
Public Class CachedTemporaryPowerBillingStatementReport
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As TemporaryPowerBillingStatementReport = New TemporaryPowerBillingStatementReport()
        rpt.Site = Me.Site
        Return rpt
    End Function
