...
Public Class WaterConsumptionGraph
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "WaterConsumptionGraph.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "PROPMANS.REPORTS.WaterConsumptionGraph.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedWaterConsumptionGraph
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As WaterConsumptionGraph = New WaterConsumptionGraph()
        rpt.Site = Me.Site
        Return rpt
    End Function
