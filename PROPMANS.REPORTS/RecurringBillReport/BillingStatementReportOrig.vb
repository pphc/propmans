...
Public Class BillingStatementReportOrig
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "BillingStatementReportOrig.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "PROPMANS.REPORTS.BillingStatementReportOrig.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property PreviouStatementBalance() As CrystalDecisions.CrystalReports.Engine.Section
        Get
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property CurrentPenaltySection() As CrystalDecisions.CrystalReports.Engine.Section
        Get
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property CurrentDiscountSection() As CrystalDecisions.CrystalReports.Engine.Section
        Get
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property RemainingAdvanceSection() As CrystalDecisions.CrystalReports.Engine.Section
        Get
...
Public Class CachedBillingStatementReportOrig
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As BillingStatementReportOrig = New BillingStatementReportOrig()
        rpt.Site = Me.Site
        Return rpt
    End Function
