...
Public Class rptMeterReading
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "PROPMANS.REPORTS.rptMeterReading.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptMeterReading
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptMeterReading = New rptMeterReading()
        rpt.Site = Me.Site
        Return rpt
    End Function
