...
Public Class rptChecksDueReport
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "PROPMANS.REPORTS.rptChecksDueReport.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptChecksDueReport
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptChecksDueReport = New rptChecksDueReport()
        rpt.Site = Me.Site
        Return rpt
    End Function
