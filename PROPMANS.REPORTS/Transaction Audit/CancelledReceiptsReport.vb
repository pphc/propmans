...
Public Class CancelledReceiptsReport
    Inherits ReportBase
...
#Region "PROPERTIES"
    ...
    Public _companySelect As String
    ...
    '    StartDate = DateFrom.ToString("MMM dd, yyyy").ToUpper
    '    EndDate = DateTo.ToString("MMM dd, yyyy").ToUpper
...
#End Region
    ...
    Private Sub LoadData()
        Try
            ...
            Dim query As String = "SELECT   or_number, payment_date,                                                                           " & _
                                  ...
                                  "         payment_type, cancellation_remarks,edited_by cancelled_by, to_char(edited_date,'DD-MON-YY HH:MI:SS PM') cancelled_on                " & _
                                  "    FROM payments ps                                                                                        " & _
                                  "   WHERE or_status = 'CAN' AND payment_date BETWEEN :startdate " & _
                                  " 											   AND :enddate " & _
