...
Public Class rptSpecialPowerOfAttorneyForm
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "rptSpecialPowerOfAttorneyForm.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "PROPMANS.REPORTS.rptSpecialPowerOfAttorneyForm.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property SpecialPowerOfAttorney() As CrystalDecisions.CrystalReports.Engine.Section
        Get
...
Public Class CachedrptSpecialPowerOfAttorneyForm
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptSpecialPowerOfAttorneyForm = New rptSpecialPowerOfAttorneyForm()
        rpt.Site = Me.Site
        Return rpt
    End Function
