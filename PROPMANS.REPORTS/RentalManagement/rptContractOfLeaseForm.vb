...
Public Class rptContractOfLeaseForm
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "rptContractOfLeaseForm.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "PROPMANS.REPORTS.rptContractOfLeaseForm.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property ContractOfLeasePage1() As CrystalDecisions.CrystalReports.Engine.Section
        Get
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property ContractOfLeasePage() As CrystalDecisions.CrystalReports.Engine.Section
        Get
...
Public Class CachedrptContractOfLeaseForm
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptContractOfLeaseForm = New rptContractOfLeaseForm()
        rpt.Site = Me.Site
        Return rpt
    End Function
