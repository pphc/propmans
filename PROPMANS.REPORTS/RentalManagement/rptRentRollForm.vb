...
Public Class rptRentRollForm
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "PROPMANS.REPORTS.rptRentRollForm.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptRentRollForm
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptRentRollForm = New rptRentRollForm()
        rpt.Site = Me.Site
        Return rpt
    End Function
