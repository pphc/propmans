...
Public Class rptLeaseEndingForm
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "PROPMANS.REPORTS.rptLeaseEndingForm.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptLeaseEndingForm
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptLeaseEndingForm = New rptLeaseEndingForm()
        rpt.Site = Me.Site
        Return rpt
    End Function
