...
Public Class rptKeyTurnOverForm
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "PROPMANS.REPORTS.rptKeyTurnOverForm.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptKeyTurnOverForm
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptKeyTurnOverForm = New rptKeyTurnOverForm()
        rpt.Site = Me.Site
        Return rpt
    End Function
