...
Public Class rptLoadBuilding
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "PROPMANS.REPORTS.rptLoadBuilding.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptLoadBuilding
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptLoadBuilding = New rptLoadBuilding()
        rpt.Site = Me.Site
        Return rpt
    End Function
