...
namespace QBooksUploader
    ...
    public class Invoice2 
        ...
        //private DateTime _beginingBalanceCutOff;
        //public DateTime BeginingBalanceCutOff {
        //    get { return _beginingBalanceCutOff; }
        //    set { _beginingBalanceCutOff = value; }
        //    }

        public string PenaltyAccntNumber {
            get { return GlobalReference.ProjectParameters.QBPenaltyAccount; }
            }
        public string CondoDuesRetainedEarningsListItem {
            get { return GlobalReference.ProjectParameters.QBPenaltyAccount; }
            }
                       ...
                       decimal penalty = decimal.Parse(dr["penalty_amt"].ToString());
                           ...
                           if (penalty > 0) {
                               ...
                               if (UploadPenalty) {
                                   string billMonth = DateTime.Parse(dr["bill_date"].ToString()).ToString("MMMM yyyy");
                                   invoiceLineAdd = invoiceAdd.ORInvoiceLineAddList.Append().InvoiceLineAdd;
                                   invoiceLineAdd.ItemRef.ListID.SetValue(PenaltyAccntNumber);
